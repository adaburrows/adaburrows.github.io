...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.263ffdf8a53a31a976079ba9a587288f00b5a650c8dbc489bc75f845bbc9f628.js',function(){input.required=false;search();});}
