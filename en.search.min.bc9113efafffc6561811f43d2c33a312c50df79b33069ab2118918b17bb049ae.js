...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6dc4974c38336369f886e544a0543a1308ba6234607a901a98831acf92e68b4a.js',function(){input.required=false;search();});}
