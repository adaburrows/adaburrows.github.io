...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.003d99d150db192cdadcd8d29ff16f7fc56f0aef5634e4ba3678ada4c270c6a0.js',function(){input.required=false;search();});}
