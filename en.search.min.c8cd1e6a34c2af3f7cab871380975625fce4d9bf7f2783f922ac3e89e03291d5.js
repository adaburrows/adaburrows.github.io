...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.8b561d1ad253dfeec4aa7d4fe52ca977666cbd22419acfc137a3ffbd23a4115b.js',function(){input.required=false;search();});}
