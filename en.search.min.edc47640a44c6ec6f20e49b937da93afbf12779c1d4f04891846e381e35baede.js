...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6b34bf2882613edc39a9b844d2253dcce6443dfc2850432836229d1dffaed77d.js',function(){input.required=false;search();});}
