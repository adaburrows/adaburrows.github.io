...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.dee729d2eaed5fa4bda73c94cd8b144576fb868e432085e5735fd5837d34d998.js',function(){input.required=false;search();});}
